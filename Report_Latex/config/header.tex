...
\usepackage[citestyle = apa, %numeric,
bibstyle=numeric]{biblatex} %style =apa %citestyle = numeric, style=numeric, bibstyle = numeric
...
%%Define better ref command \goodref 
%\newcommand*{\goodref}[1]{\hyperref[{#1}]{\autoref*{#1} }} 
%How to use: see
