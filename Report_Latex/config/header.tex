...
\usepackage[citestyle = numeric, style=numeric, bibstyle = numeric]{biblatex} %style =apa %citestyle = numeric, style=numeric, bibstyle = numeric
...
\usepackage[acronyms,shortcuts,symbols,xindy]{glossaries-extra}%,numberedsection
