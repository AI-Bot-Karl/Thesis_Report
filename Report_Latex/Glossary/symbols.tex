...
\glsxtrnewsymbol[description={rotation around x}]{roll}{\ensuremath{\theta_r}}
\glsxtrnewsymbol[description={rotation around y}]{pitch}{\ensuremath{\theta_p}}
\glsxtrnewsymbol[description={rotation around z}]{yaw}{\ensuremath{\theta_y}}

\glsxtrnewsymbol[description={Transformation matrix}]{T_hat}{\ensuremath{\hat{T}}}
\glsxtrnewsymbol[description={Transformation matrix from frame i to i-1}]{T_hat_i}{\ensuremath{{^{i-1}\hat{T}_i}}}
...
\glsxtrnewsymbol[description={link inertia matrix}]{M_hat}{\ensuremath{\hat{M}}}
